...
//Mock Service that return fake quote:
var MockRandomQuoteService =Class({
constructor:function(){},
getRandomQuote: function(){
  return { //the service return fake quote object
    line:'fake Quote',
    author:'fake author'
  }
}
...
constructor:[RandomQuoteService,function(randomQuoteService){ //injecting a service by declaring the Ctor as array, first getting the injections by name and passing it to the function Ctor arguments
  ...
  var AppModule = NgModule({
    ...
    providers:[
      //RandomQuoteService - this is sugarSyntax for writing:
      //{provide:RandomQuoteService , useClass:RandomQuoteService}, 
      //so for using the mock:
      {provide:RandomQuoteService, useClass:MockRandomQuoteService}
      //we can also create new instance of mock service by:
      //{provide:RandomQuoteService , useValue:new RandomQuoteService()}
      //or we can:
      //{provide:RandomQuoteService , useFactory:function(){return new RandomQuoteService}}
      ],//list of all services dependencies (all services in the appModule are singleton)
