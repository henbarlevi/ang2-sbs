...
app.RandomQuoteService = Class({ //adding the service to the app global object
...
})(window.app = window.app || {}); //passing window.app as argument and making sure that its an object